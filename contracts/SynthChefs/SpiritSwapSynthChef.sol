...
import "../interfaces/SynthChefs/SpiritSwapVelodrome/IGaugeSpiritSwap.sol";

contract SpiritSwapSynthChef is
    IProtocolSynthChef,
    Initializable,
    UUPSUpgradeable,
    ...
    OwnableUpgradeable
{
    ...
    /// @notice struct of SpiritSwap pool
    struct Pool {
    ...
    function harvest(
        ...
        rewardTokens[0] = pool.gauge.SPIRIT();
        amounts[0] = pool.gauge.rewards(address(this));
